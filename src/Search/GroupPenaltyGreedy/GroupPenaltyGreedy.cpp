...
GroupPenaltyGreedy::GroupPenaltyGreedy(const std::vector<Item>& items, double init_weight, int param, const Solution& solution) : Search(items, init_weight, param, solution) {
 ...
 */
std::unique_ptr<Solution> GroupPenaltyGreedy::operator()(const Solution& current_solution) {
