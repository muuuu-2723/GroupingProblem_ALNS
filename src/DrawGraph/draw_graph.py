...
ax2.grid(True)
fig1.savefig("search_fig_" + os.path.splitext(os.path.basename(data_file))[0] + ".png", bbox_inches='tight', pad_inches=0.1)
...
ax4.grid(True)
fig2.savefig("destroy_fig_" + os.path.splitext(os.path.basename(data_file))[0] + ".png", bbox_inches='tight', pad_inches=0.1)